...
import { Header, Card, Radio, Checkbox } from './components/index.js'
import './App.css'
    ...
    <div>
      ...
      <div className="footer">
        <div className="social">
          <a href="https://twitter.com/Stegosource" target="_blank" className="social-link">
          ...
          <a href="https://github.com/stegosource" target="_blank" className="social-link">
          ...
          <a href="https://www.linkedin.com/in/austin-gil-03858534/" target="_blank" className="social-link">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 448">
